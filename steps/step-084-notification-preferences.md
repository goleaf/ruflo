...
- current notification channels, mail usage, database notifications, preferences.
...
- Flux notification list, unread badges, empty state, mark read actions.
...
- notification list scoped to user.
- old links re-check authorization.
- removed members stop seeing shared notifications.
...
- private scope.
- safe link after access removed.
- personal settings.
...
- Step 084 is individually completed and not grouped with other steps.
