# DESIGN PROMPT 13 — Collaboration, invites, and member design

## Goal

Upgrade collaboration UI: shared/private indicators, member list, roles, link-only invites, role changes, removal, access denied states.
...
Touch collaboration UI and invite UI. Do not reintroduce email invites.

## Inspect before changing

Inspect shared project screens, member management, invite creation, link copy UI, role badges, access denied states, removed member behavior.

## Required implementation

Create clean member table/cards, role badge system, copy invite link panel, invite statuses, remove/role-change confirmations, shared/private labels, and safe unavailable states.

## Mobile requirements

Member list as cards; invite link copy must be easy; role actions in dropdown.

## Tablet requirements

Balanced member list with invite side panel.

## Desktop requirements

Structured member table/panel with clear role management.
...
Test link-only invite UI, no email dependency, role actions hidden/blocked for unauthorized users.

## Required report

Create or update:

`DESIGN_AGENT_REPORT_13.md`
