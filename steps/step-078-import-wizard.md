...
- data models, validation rules, duplicate strategies, storage, web processing engine.
...
- validate/preview/confirm/chunk/process.
- duplicate detection.
- result report.
- retry/resume.
...
- upload step, preview table, error report, progress bar, final summary.
...
- cannot spoof owner.
- cannot connect to another user's resources.
...
- Step 078 is individually completed and not grouped with other steps.
