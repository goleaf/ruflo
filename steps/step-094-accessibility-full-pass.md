...
- all screens touched by this step, components, mobile, keyboard, translations, microcopy.
...
- clear copy.
- consistent Flux components.
- empty/loading/error/success states.
- keyboard help if relevant.
...
- error messages must not leak private data.
- access denied states safe.
...
- pages render.
- translated strings.
- keyboard/help behavior where testable.
...
- Step 094 is individually completed and not grouped with other steps.
