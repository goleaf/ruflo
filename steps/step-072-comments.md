...
- task detail UI, collaboration roles, activity, notifications, content rendering.
...
- comment CRUD/moderation/mentions depending on step.
...
- Flux comment form/list.
- edited/deleted states.
- mention suggestions only allowed users.
...
- mentions do not leak private tasks/users.
...
- Step 072 is individually completed and not grouped with other steps.
