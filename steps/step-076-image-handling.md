...
- storage config, upload limits, public/private disks, current file handling, Livewire upload capabilities.
...
- cleanup tools.
- image handling if step requires.
...
- Flux upload controls, file cards, progress, preview only when safe.
...
- Step 076 is individually completed and not grouped with other steps.
