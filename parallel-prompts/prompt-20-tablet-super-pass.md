# DESIGN PROMPT 20 — Tablet super pass

## Goal

Perform a full tablet design pass so the app does not feel like stretched mobile or cramped desktop.
...
Focus on 768px-1199px behavior and medium-screen layout.

## Inspect before changing

Inspect dashboard, task list, detail, forms, filters, settings, collaboration, comments, attachments, import/export, admin at tablet widths.

## Required implementation

Add two-column layouts where useful, collapsible sidebars, balanced cards, non-dominating filter panels, touch-friendly but space-aware components.

## Mobile requirements

Ensure tablet changes do not break mobile stacking.

## Tablet requirements

Primary target: 768px, 820px, 1024px, 1180px.

## Desktop requirements

Ensure tablet rules transition cleanly into desktop.
...
Document tablet screenshots/manual review notes and run available page tests.

## Required report

Create or update:

`DESIGN_AGENT_REPORT_20.md`
