# DESIGN PROMPT 25 — Final design merge QA

## Goal

After parallel design prompts are merged, perform final design QA and fix merge conflicts/inconsistencies.
...
This is the final design integration pass. It can touch shared components and pages to unify them.

## Inspect before changing

Inspect every page after merge: auth, dashboard, tasks, projects, filters, Kanban, calendar, reminders, recurrence, collaboration, comments, attachments, import/export, settings, admin, help, mobile/tablet/desktop.

## Required implementation

Resolve conflicting UI patterns, remove duplicate styles, standardize Flux usage, fix translation gaps, align spacing, run final responsive/accessibility/performance checks, and create final design report.

## Mobile requirements

Full mobile regression review.

## Tablet requirements

Full tablet regression review.

## Desktop requirements

Full desktop regression review.
...
Run all available frontend/backend/Livewire tests and document failures or blockers honestly.

## Required report

Create or update:

`DESIGN_AGENT_REPORT_25.md`
