# DESIGN PROMPT 21 — Desktop super pass

## Goal

Perform a desktop/larger-screen pass for polished productivity layout.
...
Focus on 1200px+ desktop behavior, not mobile-only fixes.

## Inspect before changing

Inspect large dashboard, task lists, detail pages, admin panels, reports, settings, Kanban/calendar, and productivity views.

## Required implementation

Improve content max widths, multi-column grids, persistent sidebars, hierarchy, whitespace, dense list modes, keyboard-friendly toolbars, and large-screen empty space.

## Mobile requirements

Ensure desktop classes do not break mobile.

## Tablet requirements

Ensure desktop starts only at proper breakpoints.

## Desktop requirements

Primary target: 1200px, 1440px, 1600px, 1920px.
...
Run frontend build/checks and document desktop manual review coverage.

## Required report

Create or update:

`DESIGN_AGENT_REPORT_21.md`
