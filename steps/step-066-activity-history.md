...
- domain actions, events, current logs, dashboard recent activity, privacy risks.
...
- Flux timeline items, pagination/load more, actor/action/time display.
...
- activity visible only to allowed users.
- do not leak deleted/private content.
...
- activity created for meaningful actions.
- no activity for no-op.
- multi-user privacy.
- deleted object safe.
...
- Step 066 is individually completed and not grouped with other steps.
