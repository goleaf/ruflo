# DESIGN PROMPT 19 — Mobile super pass

## Goal

Perform a full mobile-first pass across the whole app.
...
Focus on responsive/mobile fixes. Do not redesign desktop-only features unnecessarily.

## Inspect before changing

Inspect all main pages at mobile widths: login, dashboard, tasks, detail, filters, Kanban/calendar, comments, attachments, settings, import/export, admin.

## Required implementation

Fix overflow, tap targets, sticky action issues, modal height, dropdown placement, collapsed filters, card readability, long text wrapping, bottom spacing, and mobile navigation.

## Mobile requirements

This is the primary target: 320px, 360px, 390px, 414px, 480px, and 767px behavior.

## Tablet requirements

Ensure mobile fixes do not damage tablet behavior.

## Desktop requirements

Ensure mobile-specific classes do not damage desktop layout.
...
Run responsive smoke checks where possible and document manual mobile review coverage.

## Required report

Create or update:

`DESIGN_AGENT_REPORT_19.md`
