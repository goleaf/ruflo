# DESIGN PROMPT 15 — Attachments and file UI design

## Goal

Upgrade attachment upload/list/download/preview UI while keeping private file access protected.
...
Touch attachment UI and file cards. Do not weaken storage or access rules.

## Inspect before changing

Inspect Livewire uploads, file list, preview links, download links, delete actions, upload errors, storage usage, private routes.

## Required implementation

Create Flux upload area, file cards, file type icons, size/date/uploader metadata, private badge, upload progress, invalid file errors, preview/download/delete actions, and empty state.

## Mobile requirements

File cards stack cleanly; upload area works on touch; long names wrap.

## Tablet requirements

Grid/list hybrid for files.

## Desktop requirements

Efficient file table/cards with actions aligned.
...
Test invalid file errors visible and private download links still authorize.

## Required report

Create or update:

`DESIGN_AGENT_REPORT_15.md`
