# DESIGN PROMPT 17 — Settings and preferences design

## Goal

Upgrade settings UI for personal/workspace separation, notifications, dashboard customization, timezone/language, privacy, defaults, and danger zones.
...
Touch settings UI. Do not invent toggles that do nothing.

## Inspect before changing

Inspect settings pages, tabs/sections, forms, notification preferences, privacy settings, workspace settings, reset actions.

## Required implementation

Create organized settings sections, personal/shared labels, helper text, saved states, danger zone confirmations, preference summaries, and translated setting labels.

## Mobile requirements

Settings sections collapse/stack clearly; save actions easy to reach.

## Tablet requirements

Use section sidebar or tabs where useful.

## Desktop requirements

Use settings sidebar with content panels and clear grouping.
...
Test settings save states, invalid values, role-protected workspace settings, translated labels.

## Required report

Create or update:

`DESIGN_AGENT_REPORT_17.md`
