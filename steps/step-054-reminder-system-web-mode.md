...
- due dates, notifications, preferences, cron/job assumptions, recurrence, dashboard.
...
- web-triggered reminders.
- process due reminders on dashboard/open/manual.
- track pending/processed/skipped.
...
- reminder controls, status indicators, process now button, result report.
...
- notify only correct user.
- links re-authorize.
- do not process other users unless admin allowed.
...
- completed/archived/deleted skip.
- preference disabled.
- no cron dependency.
...
- Step 054 is individually completed and not grouped with other steps.
