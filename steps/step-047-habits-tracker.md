...
- project/task relationships, progress logic, habits, dashboard.
...
- goals/milestones/habits behavior for the step.
- link tasks to goals/habits.
- calculate progress honestly.
- avoid fake stats.
...
- goal cards, habit check-in UI, progress bars with text alternatives.
...
- goal/habit data scoped to user/shared workspace.
- check-ins cannot be spoofed for other users.
...
- Step 047 is individually completed and not grouped with other steps.
