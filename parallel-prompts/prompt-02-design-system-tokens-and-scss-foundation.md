# DESIGN PROMPT 02 — Design system tokens and SCSS foundation

## Goal

Create a clean design system foundation for spacing, typography, radii, shadows, layout helpers, states, and optional SCSS helpers without fighting Tailwind or Flux.
...
Touch shared styling foundation only. Do not redesign every page in this prompt.

## Inspect before changing

Inspect Tailwind config/style entry points, SCSS/CSS files, Flux customization points, duplicated utility patterns, custom components, dark mode settings, and frontend build structure.

## Required implementation

Standardize design tokens, utility conventions, reusable SCSS helpers only where valuable, print/accessibility helpers, reduced-motion helpers, and documentation for future UI work.

## Mobile requirements

Define mobile spacing, touch targets, card padding, sticky action rules, and safe viewport behavior.

## Tablet requirements

Define tablet container widths, two-column breakpoints, side panel behavior, and medium-density spacing.

## Desktop requirements

Define desktop content width, dashboard grid behavior, sidebar width, comfortable density, and large-screen max widths.
...
Run frontend build/checks if available. Verify no broken class/config references.

## Required report

Create or update:

`DESIGN_AGENT_REPORT_02.md`
