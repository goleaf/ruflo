...
test('generated named routes use the configured https root', function () {
    expect(route('home'))->toBe('https://ruflo.test')
        ...
        ->and(route('habits.index'))->toBe('https://ruflo.test/habits')
        ->and(route('habits.create'))->toBe('https://ruflo.test/habits/create')
        ->and(route('notifications.inbox'))->toBe('https://ruflo.test/notifications')
        ...
        ->and(route('todos.time'))->toBe('https://ruflo.test/todos/time')
