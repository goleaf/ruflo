# DESIGN PROMPT 12 — Recurring task design

## Goal

Upgrade recurring task UI so users understand repeat rules, generated occurrences, skip/edit occurrence, edit series, archive/delete series, and reminders.
...
Touch recurrence UI and related modals. Do not rewrite recurrence engine unless UI reveals a rule bug.

## Inspect before changing

Inspect recurrence forms, summary text, occurrence list, edit/delete modals, skipped/edited badges, dashboard/list recurring indicators.

## Required implementation

Create human-readable repeat summary, clear occurrence vs series controls, safe confirmation dialogs, recurring badges, next occurrence preview, and mobile-friendly recurrence form.

## Mobile requirements

Use simple step-by-step recurrence settings and clear summary.

## Tablet requirements

Use form sections and preview panel.

## Desktop requirements

Use structured recurrence editor with side preview and warnings for dangerous series actions.
...
Test edit occurrence vs series UI states and translated recurrence summaries.

## Required report

Create or update:

`DESIGN_AGENT_REPORT_12.md`
