...
| Mention read boundary | `App\Queries\Todos\TodoMentionCandidateQuery` | Resolves mention candidates only from the parent task owner and active project members who already have task access. |
