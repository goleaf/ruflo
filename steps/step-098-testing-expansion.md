...
- existing test suite, gaps, factories, seeders, Livewire tests, policy tests, failing tests.
...
- expand tests in touched areas.
- add missing multi-user tests.
- add role tests.
- add upload/import/export/recurrence/settings tests.
- stabilize factories.
...
- test Livewire components where practical.
...
- privacy and authorization tests mandatory for sensitive features.
...
- Step 098 is individually completed and not grouped with other steps.
