...
test('guests are redirected from private application pages to login', function (string $url) {
    ...
    'project invite accept' => fn () => route('projects.invitations.accept', ['token' => 'InviteToken123']),
...
test('verified private routes redirect unverified users to the verification notice', function (string $url) {
...
test('private route middleware cannot be removed silently', function (string $routeName, array $expectedMiddleware) {
    ...
    'project invite accept' => ['projects.invitations.accept', ['auth', 'verified', 'signed']],
