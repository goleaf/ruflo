...
- task lifecycle, statuses, blocked/waiting needs, invalid cycles.
...
- dependency selector, blocker badges, blocked smart view.
...
- cannot depend on inaccessible tasks.
- shared dependencies follow permissions.
...
- Step 050 is individually completed and not grouped with other steps.
