# DESIGN PROMPT 23 — Microcopy, empty states, loading states, and confirmations

## Goal

Upgrade the words and states across the app so every page feels human, clear, translated, and safe.
...
Focus on text/states. Do not change core business logic.

## Inspect before changing

Inspect all buttons, labels, placeholders, helper text, empty states, loading states, error states, success toasts, danger confirmations, access denied messages, import/export reports.

## Required implementation

Add translated microcopy, helpful empty states, clear loading states, safe error states, consequence-based confirmations, and consistent success messages.

## Mobile requirements

State messages must be short and not dominate small screens.

## Tablet requirements

States should align with medium layouts.

## Desktop requirements

States should not leave huge awkward empty areas.
...
Test translation keys exist and no hardcoded visible strings remain in touched files.

## Required report

Create or update:

`DESIGN_AGENT_REPORT_23.md`
