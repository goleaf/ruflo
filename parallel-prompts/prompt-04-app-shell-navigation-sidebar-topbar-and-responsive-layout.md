# DESIGN PROMPT 04 — App shell, navigation, sidebar, topbar, and responsive layout

## Goal

Upgrade the global app shell for mobile, tablet, and desktop: navigation, sidebar, topbar, breadcrumbs/context, user menu, notification access, and primary create action.
...
Touch shared layout/navigation files and route links. Do not redesign every page body.

## Inspect before changing

Inspect authenticated layout, guest layout, navigation links, active states, user menu, notifications link, settings link, mobile menu, sidebar behavior, and shared/private workspace labels.

## Required implementation

Create a responsive shell with clear active nav, safe mobile drawer, tablet layout, desktop sidebar/topbar, quick create entry, notification indicator, settings access, and translated labels.

## Mobile requirements

Use drawer/bottom/nav pattern that avoids overflow and keeps primary actions reachable.

## Tablet requirements

Use collapsible sidebar or compact layout that keeps content readable.

## Desktop requirements

Use stable sidebar/topbar with good content max width and visible context.
...
Test guest/private navigation, active states, mobile menu toggling where possible, and no unauthorized links shown.

## Required report

Create or update:

`DESIGN_AGENT_REPORT_04.md`
