...
- query counts, N+1 risks, large lists, dashboard widgets, Livewire rerenders, imports/exports, attachments.
...
- do not block whole page unnecessarily.
...
- cache must not mix users/workspaces.
- performance optimizations must not bypass policies.
...
- query/performance assertions where available.
- large seeded scenario smoke tests.
...
- Step 096 is individually completed and not grouped with other steps.
